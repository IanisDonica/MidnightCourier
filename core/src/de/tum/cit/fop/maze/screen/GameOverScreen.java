...
/**
 * Game over screen shown when the player is arrested.
 */
public class GameOverScreen extends BaseEndScreen {
    /**
    ...
    public GameOverScreen(MazeRunnerGame game) {
        super(game, "Assets_Map/arrested.png");
    }
    ...
    protected String getSubtitleText() {
        return "Next time bring bribe money";
    }
    ...
    protected void buildButtons(Table buttons) {
        TextButton retryButton = createButton("Get bailed out", () -> {
