...
/**
 * Game over screen shown after triggering a trap.
 */
public class TrapOverScreen implements Screen {
    ...
    public TrapOverScreen(MazeRunnerGame game) {
        ...
        statsTable.setBackground(game.getSkin().getDrawable("whiteBlack"));
